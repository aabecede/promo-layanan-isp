                                    ...
                                    <table className="table align-items-center justify-content-center mb-0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th className="text-uppercase text-secondary text-xxs font-weight-bolder text-left opacity-7 ps-2">Roles</th>
                                                ...
                                                <tr key={user.id}>
                                                    ...
                                                    <td className='text-left'>
                                                        <div className="d-flex px-2">
                                                            <div>
                                                                <img src={`${assetPath}/img/team-2.jpg`} key={index} className="avatar avatar-sm  me-3 " />
                                                            </div>
                                                    ...
                                                    <td className='text-left'>
                                                        <span className="text-xs font-weight-bold">{user.roles}</span>
                                                    </td>
